    ...
    return (
        <div className="bg-cyan-600/60  w-3xl p-5 m-5 ml-auto mr-auto rounded-md items-center grid grid-rows-2  ">
            ...
            <div style={styles.section}>
                <h3 className="pb-2 ">Search Patient by ID</h3>
                    <input
                    type="number"
                ...
                />
                    <button onClick={searchPatient} className=" border mt-2 text-purple-600 hover:border-purple-900 hover:bg-purple-600 hover:text-white active:bg-purple-700 rounded-lg p-3 ml-2 w-xs">
                        Search
                    </button>
                        </div>

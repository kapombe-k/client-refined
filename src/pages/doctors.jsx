...
export default function DoctorComponent() {
    ...
    return (
        <div className="bg-cyan-600/60  w-3xl p-5 m-5 ml-auto mr-auto rounded-md items-center grid grid-rows-2  ">
            <h2 className="ml-auto mr-auto items-center font-bold text-black text-2xl">Doctor Management</h2>
            ...
            {/* Add New Doctor */}
                <div style={styles.section}>
                    <h3 className="pb-2 ">Add New Doctor</h3>
                    <form onSubmit={addDoctor} style={styles.form}>
                        ...
                        />
                        <button type="submit" className="border text-purple-600 hover:border-purple-900 hover:bg-purple-600 hover:text-white active:bg-purple-700 rounded-lg p-3 w-xs">
                            Add Doctor
                        </button>
                    </form>
                </div>
                ...
                {/* Search Doctor */}
                <div  style={styles.section} >
                    <h3 className="pb-2 ">Search Doctor by ID</h3>
                    <input
                        type="number"
                        placeholder="Doctor ID"
                        value={searchId}
                        onChange={(e) => setSearchId(e.target.value)}
                        className="border text-purple-600 hover:border-purple-900 hover:bg-purple-600 hover:text-white active:bg-purple-700 rounded-lg p-3 ml-2 w-xs"
                    />
                    <button onClick={searchDoctor} className=" border mt-2 text-purple-600 hover:border-purple-900 hover:bg-purple-600 hover:text-white active:bg-purple-700 rounded-lg p-3 ml-2 w-xs">
                        Search
                    </button>
           </div>
                {foundDoctor && (
                    <div style={styles.searchResult}>
                        ...
                        <button
                            ...
                            className="mt-1 border-2 rounded-md p-2 bg-cyan-900 text-white"
                        >
                            Delete
                        </button>
                    </div>
